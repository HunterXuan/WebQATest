...
x_train_1, x_train_2, x_train_3 = data_helpers.load_train_set(vocab, train_data, FLAGS.batch_size)
  ...
  with tf.device("/gpu:1"):
    ...
    with sess.as_default():
        ...
        for i in range(FLAGS.num_epochs):
            try:
                x_batch_1, x_batch_2, x_batch_3 = data_helpers.load_train_set(vocab, train_data, FLAGS.batch_size)
